...
### 3.4 Frontend
- Next.js app router; JWT storage as planned here was in memory plus an httpOnly
  cookie. The implementation uses `localStorage` instead; the reasoning and the
  trade-off are disclosed under "Token storage" in the README.
